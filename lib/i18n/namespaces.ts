 ...
 */
export const NAMESPACES = ["common", "nav", "auth", "marketing", "dashboard", "kanji", "vocab", "grammar", "videos", "dictation", "shadowing", "mining", "jlpt", "reading", "conversation", "community", "playlists", "leaderboard", "profile"] as const;
