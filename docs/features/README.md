...
| F-002 | Unknown Word Heatmap            | High     | 3     | 🟡 Planned | SRS data (Layer 2)        | S/M    |
| F-003 | Learning Journey                | High     | 6     | 🟡 Planned | SRS data, video progress  | S      |
| F-004 | Difficulty Timeline             | Medium   | 6     | 🟡 Planned | F-002, i+1 engine         | S      |
| F-005 | Learn Before Watching           | High     | 3     | 🟡 Planned | F-002, SRS, transcript    | M      |
| F-006 | Shadowing Replay Timeline       | Medium   | 3     | 🟡 Planned | Shadowing sessions        | M      |
...
| F-010 | Review by Context               | High     | 2/3   | 🟡 Planned | Sentence mining, SRS      | L      |
