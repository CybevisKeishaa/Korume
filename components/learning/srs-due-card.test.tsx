...
describe("SrsDueCard", () => {
  it("shows the due count and links to both review queues", () => {
    ...
    expect(screen.getByRole("link", { name: /review vocab/i })).toHaveAttribute("href", "/vocab/review");
    expect(screen.getByRole("link", { name: /review kanji/i })).toHaveAttribute("href", "/kanji/review");
  });
